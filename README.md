...
This Eclipse plug-in provides source code validation. Pousse-Café nature must be added to a project in order to enable
...
2. Click on "Configure > Enable Pousse-Café nature"
